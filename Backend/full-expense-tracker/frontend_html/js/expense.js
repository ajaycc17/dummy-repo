...
async function showItems() {
    ...
    try {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            tdExp.appendChild(document.createTextNode("₹" + data[i].expense));
            tr.appendChild(tdExp);

            // add desc
            const tdDesc = document.createElement("td");
            tdDesc.appendChild(document.createTextNode(data[i].description));
            tr.appendChild(tdDesc);

            // add category
            const tdCategory = document.createElement("td");
            tdCategory.appendChild(document.createTextNode(data[i].category));
        ...
        if (isPremium) {
            ...
            // add the total details
            {
                ...
                tillNowTr.classList = "bg-red-50 font-semibold text-red-800";
                const tdEmp1 = document.createElement("td");
                tdEmp1.colSpan = "4";
                const tdTotal = document.createElement("td");
                tdEmp1.appendChild(document.createTextNode("Total Expense:"));
                tdTotal.appendChild(document.createTextNode("₹" + tillNowExp));
